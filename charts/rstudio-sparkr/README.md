...
| probe.probeValue.livenessProbe.httpGet.path | string | `"/"` |  |
| probe.probeValue.livenessProbe.httpGet.port | string | `"http"` |  |
| probe.probeValue.readinessProbe.httpGet.path | string | `"/"` |  |
| probe.probeValue.readinessProbe.httpGet.port | string | `"http"` |  |
| probe.probeValue.startupProbe.failureThreshold | int | `60` |  |
| probe.probeValue.startupProbe.httpGet.path | string | `"/"` |  |
| probe.probeValue.startupProbe.httpGet.port | string | `"http"` |  |
| probe.probeValue.startupProbe.initialDelaySeconds | int | `10` |  |
| probe.probeValue.startupProbe.periodSeconds | int | `10` |  |
| probe.probeValue.startupProbe.successThreshold | int | `1` |  |
| probe.probeValue.startupProbe.timeoutSeconds | int | `5` |  |
| replicaCount | int | `1` |  |
